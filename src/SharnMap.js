...
function SharnMap(props) {
  ...
  const displayDivision = d => {
    if (hoverActive) {
      setDivision(d);
      setActiveDivision(wards[d]);
    }
  };

  const lockDivision = d => {
    if (d === division) {
  ...
  const printLocation = (location, name) => {
    let locStr = "";
        ...
        ward.districts.forEach(district => {
          ...
          for (var key in district) {
            if (
              ...
              arr[count] += printLocation(district[key], ward.name);
            }
      ...
      if (ward.other) {
        ...
        for (var key in ward.other) {
          if (
            ...
            arr[count] += printLocation(ward.other[key], ward.name);
          }
          if (key === "description" || key === "districtName") count--;
          count++;
        }
  ...
  return (
    <div className="container_wrap">
      <div className="row">
        <div className="map_wrap col-md-6">
          <img
            src={map}
            useMap="#sharn-map"
            alt="sharn_map"
          ...
          <map name="sharn-map" id="smap">
            <area
              onClick={() => lockDivision(0)}
              onMouseEnter={() => displayDivision(0)}
              target=""
              alt="Cliffside"
              title="Cliffside"
            ...
            />
            <area
              onClick={() => lockDivision(2)}
              onMouseEnter={() => displayDivision(2)}
              target=""
              alt="Lower Central"
              title="Lower Central"
            ...
            />
            <area
              onClick={() => lockDivision(4)}
              onMouseEnter={() => displayDivision(4)}
              target=""
            ...
            />
            <area
              onClick={() => lockDivision(5)}
              onMouseEnter={() => displayDivision(5)}
              target=""
              alt="Lower Northedge"
            ...
            />
            <area
              onClick={() => lockDivision(3)}
              onMouseEnter={() => displayDivision(3)}
              target=""
              alt="Lower Dura"
              title="Lower Dura"
            ...
            />
            <area
              onClick={() => lockDivision(6)}
              onMouseEnter={() => displayDivision(6)}
              target=""
            ...
            />
            <area
              onClick={() => lockDivision(14)}
              onMouseEnter={() => displayDivision(14)}
              target=""
              alt="The Depths"
              title="The Depths"
            ...
            />
            <area
              onClick={() => lockDivision(13)}
              onMouseEnter={() => displayDivision(13)}
              target=""
              alt="The Cogs"
              title="The Cogs"
            ...
            />
            <area
              onClick={() => lockDivision(1)}
              onMouseEnter={() => displayDivision(1)}
              target=""
              alt="Lava Pools"
              title="Lava Pools"
            ...
            />
            <area
              onClick={() => lockDivision(7)}
              onMouseEnter={() => displayDivision(7)}
              target=""
              alt="Middle Central"
            ...
            />
            <area
              onClick={() => lockDivision(9)}
              onMouseEnter={() => displayDivision(9)}
              target=""
            ...
            />
            <area
              onClick={() => lockDivision(10)}
              onMouseEnter={() => displayDivision(10)}
              target=""
            ...
            />
            <area
              onClick={() => lockDivision(8)}
              onMouseEnter={() => displayDivision(8)}
              target=""
              alt="Middle Dura"
              title="Middle Dura"
            ...
            />
            <area
              onClick={() => lockDivision(11)}
              onMouseEnter={() => displayDivision(11)}
              target=""
            ...
            />
            <area
              onClick={() => lockDivision(12)}
              onMouseEnter={() => displayDivision(12)}
              target=""
              alt="Skyway"
              title="Skyway"
            ...
            />
            <area
              onClick={() => lockDivision(16)}
              onMouseEnter={() => displayDivision(16)}
              target=""
              alt="Upper Dura"
              title="Upper Dura"
            ...
            />
            <area
              onClick={() => lockDivision(15)}
              onMouseEnter={() => displayDivision(15)}
              target=""
              alt="Upper Central"
              title="Upper Central"
            ...
            />
            <area
              onClick={() => lockDivision(17)}
              onMouseEnter={() => displayDivision(17)}
              target=""
            ...
            />
            <area
              onClick={() => lockDivision(19)}
              onMouseEnter={() => displayDivision(19)}
              target=""
            ...
            />
            <area
              onClick={() => lockDivision(18)}
              onMouseEnter={() => displayDivision(18)}
              target=""
              alt="Upper Northedge"
        ...
        <div className="sidebar col-md-6">
          <div className="row">
            <div className="col-md-10">
              {division !== -1 ? (
                <SidebarWard ward={activeDivision} />
              ) : (
                <div
                  className="pt-4"
                  dangerouslySetInnerHTML={{ __html: locList }}
                />
              )}
            </div>
