            ...
            <div className="row">
              <div className="col-md-10">
                {this.state.division !== -1 ? (
                  <SidebarWard ward={this.state.activeDivision} />
                ) : (
                  <div
                    className="pt-4"
                    dangerouslySetInnerHTML={{ __html: this.state.locList }}
                  />
                )}
              </div>
              <div className="col-md-2 pt-4">
                <button onClick={this.handleShowAll} className="btn btn-info">
                  Show All
                </button>
              </div>
            </div>
