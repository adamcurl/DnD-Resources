  ...
  return (
    <div className="container_wrap">
      ...
      <p>
        ...
        communicate with their followers. Other faiths, like the Blood of Vol or
        the Path of Light don't worship a diety. Instead, they focus on a
        manifestation of an idea or attribute. The Undying Court worships the
        very real council of ancient elves instead of a diety. Others are more
        of a creed, such as Druids, or Spirits of the Past. In Eberron, it's not
        the gods, demons, or spirits that give powers to paladins and clerics,
        but it is the faith of the player that gives them their power.
      </p>
      <div className="row">
