    ...
    <div className="container_wrap">
      <div className="homeland_wrap">
        <div>
          ...
          <p>
            Click on the country names below to learn more about them and select
            where your character is from. Think about the races, religions, and
            house headquarters in that country. You can view this map in{" "}
            <a target="_blank" href={map} rel="noopener noreferrer">
              Fullscreen
            </a>{" "}
            if you need to zoom in to find a city to be your hometown.
          </p>
        </div>
